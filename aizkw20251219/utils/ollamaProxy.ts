...
const OLLAMA_URL = 'https://placed-reporter-cite-alabama.trycloudflare.com/api/chat';
...
export async function checkOllamaAvailable(): Promise<boolean> {
  try {
    const response = await fetch('https://placed-reporter-cite-alabama.trycloudflare.com/api/tags', {
      method: 'GET',
      mode: 'cors',
    });
    return response.ok;
