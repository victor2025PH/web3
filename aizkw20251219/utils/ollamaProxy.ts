...
const OLLAMA_URL = 'https://dec-reading-trademark-photographs.trycloudflare.com/api/chat';
...
export async function checkOllamaAvailable(): Promise<boolean> {
  try {
    const response = await fetch('https://dec-reading-trademark-photographs.trycloudflare.com/api/tags', {
      method: 'GET',
      mode: 'cors',
    });
    return response.ok;
