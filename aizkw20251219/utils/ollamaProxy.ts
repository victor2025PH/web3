...
const OLLAMA_URL = 'https://slowly-vanilla-finish-democratic.trycloudflare.com/api/chat';
...
export async function checkOllamaAvailable(): Promise<boolean> {
  try {
    const response = await fetch('https://slowly-vanilla-finish-democratic.trycloudflare.com/api/tags', {
      method: 'GET',
      mode: 'cors',
    });
    return response.ok;
