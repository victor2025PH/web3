...
const OLLAMA_URL = 'https://participating-spoken-11c-lists.trycloudflare.com/api/chat';
...
export async function checkOllamaAvailable(): Promise<boolean> {
  try {
    const response = await fetch('https://participating-spoken-11c-lists.trycloudflare.com/api/tags', {
      method: 'GET',
      mode: 'cors',
    });
    return response.ok;
